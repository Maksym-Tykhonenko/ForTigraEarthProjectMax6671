...
const FACEBOOK_APP_ID = '1694627954887554'; //<---- Replace with your actual Facebook App ID
const FACEBOOK_APP_NAME = 'For Tigra Earth Project'; //<---- Replace with your actual Facebook App Name
